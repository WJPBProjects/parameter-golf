...
| PR824 + AttnRes-lite | BLOCKED | HOLD | TODO | `codex/pr824-attnres-lite` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-attnres-lite` | `codex_notes/scratchpads/pr824-attnres-lite.md` | `pr824_stacks_20260402` failed immediately with `TypeError: GPT.__init__() got an unexpected keyword argument 'attnres_enable'`; fix constructor plumbing before rerunning. |
