...
| PR824 + QK_GAIN=5.0 | BLOCKED | HOLD | TODO | `codex/pr824-qkgain5` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-qkgain5` | `codex_notes/scratchpads/pr824-qkgain5.md` | Manual stop: this branch is currently just standalone `QK_GAIN=5.0`, not PR824 + QK gain, so the trainer needs to be rebuilt from the PR824 mimic stack before rerun. |
| PR824 with XSA last 4 | BLOCKED | HOLD | TODO | `codex/pr824-xsa4` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-xsa4` | `codex_notes/scratchpads/pr824-xsa4.md` | Manual stop: this branch still runs/logs `xsa_last_n:6`, not `4`, so either the trainer default or the runner env needs to be fixed before rerun. |
