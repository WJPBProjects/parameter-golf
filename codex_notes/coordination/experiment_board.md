...
| PR824 with XSA last 4 | IN_PROGRESS:main-agent | HOLD | TODO | `codex/pr824-xsa4` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-xsa4` | `codex_notes/scratchpads/pr824-xsa4.md` | Running in `pr824_fixups_20260402`; trainer now logs `xsa_last_n:4 active_layers:[5, 6, 7, 8]`, so the repair is valid. |
