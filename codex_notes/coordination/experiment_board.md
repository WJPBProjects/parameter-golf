...
| PR824 + QK_GAIN=5.0 + KGIIR-lite | TODO | HOLD | TODO | `codex/pr824-qkgain5-kgiir-lite` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-qkgain5-kgiir-lite` | `codex_notes/scratchpads/pr824-qkgain5-kgiir-lite.md` | Single stack hypothesis: start from the current best QK-gain PR824 branch and add the 4-tap KGIIR-lite causal mixer before attention. |
