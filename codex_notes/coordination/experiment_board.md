...
| MoHD last-MLP lite | IN_PROGRESS:main-agent | HOLD | TODO | `codex/mohd-lastmlp-lite` | `/Users/wulfie/code/parameter-golf-worktrees/mohd-lastmlp-lite` | `codex_notes/scratchpads/mohd-lastmlp-lite.md` | Running in `next_frontier_lite_20260402`; branch-local gated tail-channel MLP path added to the last decoder blocks. |
