...
| PR824 + KGIIR-lite | PASS | READY | TODO | `codex/pr824-kgiir-lite` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-kgiir-lite` | `codex_notes/scratchpads/pr824-kgiir-lite.md` | Fresh stack result `1.65947391` beats baseline `1.69449315`, PR824 mimic `1.66770976`, and the earlier `pr824-qkgain5` winner `1.66190993`; this is the new best local branch, with a moderate speed cost (`348.85ms/step`). |
