...
| PR824 + Softpick-lite | IN_PROGRESS:main-agent | HOLD | TODO | `codex/pr824-softpick-lite` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-softpick-lite` | `codex_notes/scratchpads/pr824-softpick-lite.md` | One-step smoke passed; running a manual confirm pass now to get post-quant BPB and measure the manual-attention speed penalty. |
