...
| PR824 + QK_GAIN=5.0 | IN_PROGRESS:main-agent | HOLD | TODO | `codex/pr824-qkgain5` | `/Users/wulfie/code/parameter-golf-worktrees/pr824-qkgain5` | `codex_notes/scratchpads/pr824-qkgain5.md` | Running in `pr824_fixups_20260402` against fresh baseline `1.69615068` and fresh PR824 mimic `1.66833719`; branch default `QK_GAIN_INIT=5.0` was verified in the trainer source. |
