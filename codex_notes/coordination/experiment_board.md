...
| Attention Residuals-lite | IN_PROGRESS:main-agent | HOLD | TODO | `codex/attnres-lite` | `/Users/wulfie/code/parameter-golf-worktrees/attnres-lite` | `codex_notes/scratchpads/attnres-lite.md` | Currently running in `explore_lite_20260402`; last-4-layer 2-source learned mixer over current residual and skip source, identity-biased toward the baseline path. |
