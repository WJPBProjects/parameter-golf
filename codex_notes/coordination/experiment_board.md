...
| Hyperconnection-lite | IN_PROGRESS:main-agent | HOLD | TODO | `codex/hyperconnection-lite` | `/Users/wulfie/code/parameter-golf-worktrees/hyperconnection-lite` | `codex_notes/scratchpads/hyperconnection-lite.md` | Currently running in `explore_lite_20260402`; minimal late-layer split-state residual router, intentionally much smaller than a full Hyper-Connections reproduction. |
