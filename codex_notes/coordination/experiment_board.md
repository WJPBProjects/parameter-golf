...
| KGIIR-lite | IN_PROGRESS:main-agent | HOLD | TODO | `codex/kgiir-lite` | `/Users/wulfie/code/parameter-golf-worktrees/kgiir-lite` | `codex_notes/scratchpads/kgiir-lite.md` | Currently running in `explore_lite_20260402`; minimal identity-biased 4-tap causal temporal mixer before the attention path. |
