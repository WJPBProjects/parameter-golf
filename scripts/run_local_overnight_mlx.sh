...
export RUN_ID="${RUN_ID:-local_overnight_$(date +%Y%m%d_%H%M%S)}"
...
export DEV_VAL_MAX_BATCHES="${DEV_VAL_MAX_BATCHES:-0}"
...
export MAX_WALLCLOCK_SECONDS="${MAX_WALLCLOCK_SECONDS:-21600}"
