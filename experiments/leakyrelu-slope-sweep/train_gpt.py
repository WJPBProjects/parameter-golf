...
class Hyperparameters:
    ...
    leaky_relu_negative_slope = float(os.environ.get("LEAKY_RELU_NEGATIVE_SLOPE", 0.0))
...
class MLP(nn.Module):
    # LeakyReLU^2 MLP from the original modded-nanogpt setup.
    # Keep negative_slope=0.0 to recover the exact relu^2 baseline.
...
def main() -> None:
    ...
    log0(f"leaky_relu_negative_slope:{args.leaky_relu_negative_slope}")
